...
Revision ID: 0432197d9cd4
Revises: 
Create Date: 2018-02-26 19:04:30.599401
...
def upgrade():
    ...
    sa.Column('degree_requirement', sa.String(length=50), nullable=True),
    ...
    sa.Column('resume_url', sa.String(length=100), nullable=True),
    ...
    sa.Column('desription', sa.String(length=100), nullable=True),
    ...
    sa.Column('team_introduction', sa.String(length=200), nullable=True),
    sa.Column('welfares', sa.String(length=200), nullable=True),
    sa.Column('field', sa.String(length=50), nullable=True),
    sa.Column('finance_stage', sa.String(length=100), nullable=True),
    ...
    sa.Column('technologys', sa.String(length=100), nullable=True),
    sa.Column('resume_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['resume_id'], ['resume.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
